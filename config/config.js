...
var initGlobalConfigFiles = function (config, assets) {
  ...
  config.files.client.js = getGlobbedPaths(assets.client.lib.js, 'public/').concat(getGlobbedPaths(assets.client.js));

  // Setting Globbed css files
  config.files.client.css = getGlobbedPaths(assets.client.lib.css, 'public/').concat(getGlobbedPaths(assets.client.css));
...
var initGlobalConfig = function () {
  ...
  var aboree = require(path.resolve('./package.json'));
  config.abrv = aboree;
